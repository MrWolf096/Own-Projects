    ...
    public static void main(String[] args) {
        ...
        do {
            if (option == 1) {
                ...
                System.out.println("1.Insert the surname of the author:");
            ...
            if (option == 4) {
                ...
                String input1 = scanner1.nextLine();
                System.out.println("-The surname of the author:");
                String input2 = scanner1.nextLine();
                ...
                String input3 = scanner1.nextLine();
                System.out.println("Enter the new surname of the author:");
