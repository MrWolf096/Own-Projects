    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            if (option == 4) {
                ...
                System.out.println("1.The first name of the author:");
                String input1 = scanner1.nextLine();

                System.out.println("2.The last name of the author:");
                String input2 = scanner1.nextLine();
            ...
            if (option == 7) {
                System.out.println("Insert the first name and last name of the author:");
                ...
                try {
                    ...
                    Query query = session.createQuery("from Authors where name=:newName and surnameAuthor=:newSurname");
                    query.setParameter("newName",inputName);
                    query.setParameter("newSurname",inputLastName);
                    Authors authorAdd = (Authors) query.getResultList().get(0);
                    System.out.println(authorAdd);

                } catch (Exception e) {
                    System.err.println("The author have not been found.");
                }

            }
            if (option == 8) {
                System.out.println("The books are:");
                Query result = session.createQuery("from Books");
                List<Books> list = result.getResultList();
                for (Books b : list) {
